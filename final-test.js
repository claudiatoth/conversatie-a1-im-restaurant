// ============================================
// TEST FINAL - Im Restaurant: Essen bestellen (Conversație A1)
// Claudia Toth · 15 întrebări (vocab, articole, comandă, fraze, dialog)
// REGULĂ QA: fără ghilimele interioare ASCII în stringuri de date.
// ============================================

const finalTestData = [
    { type: 'multiple', category: '📖 Vocabular', question: 'Ce înseamnă „die Suppe"?', options: ['salata', 'supa', 'pâinea', 'sucul'], correct: 'supa', explanation: 'die Suppe = supa.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Ce înseamnă „der Saft"?', options: ['berea', 'vinul', 'sucul', 'ceaiul'], correct: 'sucul', explanation: 'der Saft = sucul (plural: die Säfte).' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Ce înseamnă „die Rechnung"?', options: ['meniul', 'nota de plată', 'masa', 'bacșișul'], correct: 'nota de plată', explanation: 'die Rechnung = nota de plată.' },
    { type: 'multiple', category: '🧩 Articol', question: 'Ce articol? ____ Kaffee', options: ['der', 'die', 'das'], correct: 'der', explanation: 'der Kaffee — masculin.' },
    { type: 'multiple', category: '🧩 Articol', question: 'Ce articol? ____ Wasser', options: ['der', 'die', 'das'], correct: 'das', explanation: 'das Wasser — neutru.' },
    { type: 'multiple', category: '🧩 Articol', question: 'Ce articol? ____ Pizza', options: ['der', 'die', 'das'], correct: 'die', explanation: 'die Pizza — feminin.' },
    { type: 'multiple', category: '🍽️ Comandă', question: 'Completează: Ich möchte ____ Salat. (der Salat)', options: ['ein', 'eine', 'einen'], correct: 'einen', explanation: 'der Salat (masculin) → einen Salat.' },
    { type: 'multiple', category: '🍽️ Comandă', question: 'Completează: Ich möchte ____ Suppe. (die Suppe)', options: ['ein', 'eine', 'einen'], correct: 'eine', explanation: 'die Suppe (feminin) → eine Suppe.' },
    { type: 'luckentext', category: '🍽️ Comandă', question: 'Completează cu articolul de comandă:', sentence: 'Ich möchte ______ Wasser. (das Wasser)', translation: 'Aș dori o apă.', accept: ['ein'], correct: 'ein', explanation: 'das Wasser (neutru) → ein Wasser.' },
    { type: 'luckentext', category: '🗣️ Fraze', question: 'Completează (ceri nota de plată):', sentence: 'Die ______, bitte!', translation: 'Nota de plată, vă rog!', accept: ['Rechnung'], correct: 'Rechnung', explanation: 'Die Rechnung, bitte. = Nota de plată, vă rog.' },
    { type: 'multiple', category: '🗣️ Fraze', question: 'Cum întrebi cât costă?', options: ['Wie heißt das?', 'Was kostet das?', 'Wo ist das?', 'Wer ist das?'], correct: 'Was kostet das?', explanation: 'Was kostet das? = Cât costă asta?' },
    { type: 'multiple', category: '🗣️ Fraze', question: 'Cum comanzi politicos o pizza?', options: ['Pizza!', 'Ich will Pizza.', 'Ich möchte eine Pizza.', 'Gib mir Pizza.'], correct: 'Ich möchte eine Pizza.', explanation: 'Ich möchte… = forma politicoasă de comandă.' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was bestellt Andreea zum Essen?', options: ['eine Pizza', 'eine Suppe und einen Salat', 'ein Schnitzel', 'einen Fisch'], correct: 'eine Suppe und einen Salat', explanation: 'Andreea: „Ich möchte gern eine Suppe und einen Salat."' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was kostet das Essen zusammen?', options: ['10 Euro', '12 Euro', '15 Euro', '20 Euro'], correct: '12 Euro', explanation: 'Mihai: „das macht zusammen zwölf Euro" (12 Euro).' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Wie bezahlt Andreea?', options: ['bar', 'mit Karte', 'gar nicht', 'mit Trinkgeld'], correct: 'mit Karte', explanation: 'Andreea: „Ich zahle mit Karte."' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong>: vocabular, articole, comandă (ein/eine/einen), fraze și înțelegerea dialogului.</p>
