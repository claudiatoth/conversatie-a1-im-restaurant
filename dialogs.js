// ============================================
// DIALOGS.JS — Im Restaurant: dialog animat
// Andreea (🇷🇴) ↔ Mihai (🧑‍🍳) · sync pe audio.currentTime + timer fallback
// Fără TTS (vocea Claudiei se înregistrează într-un singur MP3 cu pauze)
// ============================================

const dialog1Data = {
    id: 'dialog1',
    title: 'Andreea & Mihai — Im Restaurant',
    context: 'Andreea ia prânzul la restaurantul lui Mihai. El îi aduce meniul, ea comandă mâncare și băutură, întreabă prețul și plătește.',
    audioFile: 'audio/dialog-01.mp3',
    totalDuration: 45,
    replici: [
        { id: 1, speaker: 'mihai',   start: 0,  duration: 5, de: 'Guten Tag, Andreea! Herzlich willkommen. Hier ist die Speisekarte.', ro: 'Bună ziua, Andreea! Bine ai venit. Iată meniul.' },
        { id: 2, speaker: 'andreea', start: 5,  duration: 6, de: 'Danke, Mihai! Ich möchte gern eine Suppe und einen Salat.', ro: 'Mulțumesc, Mihai! Aș dori o supă și o salată.' },
        { id: 3, speaker: 'mihai',   start: 11, duration: 4, de: 'Sehr gern. Und was möchten Sie trinken?', ro: 'Cu plăcere. Și ce doriți să beți?' },
        { id: 4, speaker: 'andreea', start: 15, duration: 5, de: 'Ein Wasser, bitte. Was kostet das zusammen?', ro: 'O apă, vă rog. Cât costă în total?' },
        { id: 5, speaker: 'mihai',   start: 20, duration: 6, de: 'Die Suppe, der Salat und das Wasser — das macht zusammen zwölf Euro.', ro: 'Supa, salata și apa — fac în total doisprezece euro.' },
        { id: 6, speaker: 'andreea', start: 26, duration: 4, de: 'In Ordnung. Das Essen ist sehr lecker!', ro: 'În regulă. Mâncarea e foarte gustoasă!' },
        { id: 7, speaker: 'mihai',   start: 30, duration: 4, de: 'Das freut mich! Möchten Sie noch einen Nachtisch?', ro: 'Mă bucur! Mai doriți un desert?' },
        { id: 8, speaker: 'andreea', start: 34, duration: 6, de: 'Nein, danke. Die Rechnung, bitte. Ich zahle mit Karte.', ro: 'Nu, mulțumesc. Nota de plată, vă rog. Plătesc cu cardul.' },
        { id: 9, speaker: 'mihai',   start: 40, duration: 5, de: 'Natürlich. Vielen Dank und bis bald, Andreea!', ro: 'Desigur. Mulțumesc mult și pe curând, Andreea!' }
    ]
};

const dialogsById = { dialog1: dialog1Data };

function speakerLabel(s) { return s === 'andreea' ? '🇷🇴 Andreea' : '🧑‍🍳 Mihai'; }
...
function avatarHTML(speaker) {
    ...
    return `<div class="character-avatar"><img src="images/mihai.png" alt="Mihai"></div>`;
}
        ...
        <div class="animated-dialog" id="dialog-${data.id}" data-dialog-id="${data.id}">
            ...
            <div class="stage-container">
                <div class="stage">
                    ...
                    <div class="character-wrapper character-mihai" data-speaker="mihai">
                        ${avatarHTML('mihai')}
                        <div class="character-label">Mihai 🧑‍🍳</div>
                        <div class="speech-bubble speech-mihai" id="bubble-${data.id}-mihai"><div class="bubble-de"></div><div class="bubble-ro"></div></div>
                    </div>
                </div>
